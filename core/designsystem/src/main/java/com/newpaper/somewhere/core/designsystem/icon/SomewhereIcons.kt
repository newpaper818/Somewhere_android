...
object NavigationBarIcon {
    val myTripsFilled = MyIcon(Icons.Rounded.Luggage,     24.dp, false, null, R.string.trips)
    val myTripsOutlined = MyIcon(Icons.Outlined.Luggage,  24.dp, true,  null, R.string.trips)
