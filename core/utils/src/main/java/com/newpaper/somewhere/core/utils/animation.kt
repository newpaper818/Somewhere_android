...
val enterVerticallyDelay =  expandVertically(tween(350, delayMillis = 150)) +  fadeIn(tween(300, delayMillis = 350))
val exitVertically =        shrinkVertically(tween(350, delayMillis = 150)) + fadeOut(tween(300))

val enterVerticallyDelayForMaxTrips = expandVertically(tween(350, delayMillis = 800)) + fadeIn(tween(300, delayMillis = 1000))
...
val enterVerticallyScaleInDelay =   scaleIn(animationSpec = tween(300, delayMillis = 400)) +  expandVertically(tween(250, delayMillis = 250)) +  fadeIn(tween(350, delayMillis = 400))
