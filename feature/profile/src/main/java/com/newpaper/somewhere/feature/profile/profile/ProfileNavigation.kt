...
fun NavController.navigationToProfile(navOptions: NavOptions) = navigate(NavDestination.PROFILE_ROUTE.route, navOptions)
...
fun NavGraphBuilder.profile(
    ...
    composable(
        route = NavDestination.PROFILE_ROUTE.route,
        deepLinks = listOf(
