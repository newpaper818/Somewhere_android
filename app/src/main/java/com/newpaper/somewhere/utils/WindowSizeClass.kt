...
import androidx.compose.ui.unit.dp
import com.newpaper.somewhere.ui.screenUtils.commonScreenUtils.NAVIGATION_BOTTOM_BAR_WIDTH
import com.newpaper.somewhere.ui.screenUtils.commonScreenUtils.NAVIGATION_DRAWER_BAR_WIDTH
import com.newpaper.somewhere.ui.screenUtils.commonScreenUtils.NAVIGATION_RAIL_BAR_WIDTH
...
class WindowSizeClass private constructor(
    ...
    companion object {
        ...
        fun calculateFromSize(size: DpSize): WindowSizeClass {
            ...
            val spacerValue = if (windowWidthSizeClass == WindowWidthSizeClass.Compact) SPACER_SMALL else SPACER_BIG
